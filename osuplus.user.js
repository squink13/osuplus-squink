...
(() => {
    ...
    function osuplusNewMp(){
        ...
        function addCss(){
            if(!$(".osuplus-new-mp-style").length){
                $(document.head).append($("<style class='osuplus-new-mp-style'></style>").html(
                    ...
                    .mc-mc {display: inline-block; width: 100px; text-align: right;}
                            ...
                            <div class='mc-result'>
                                <table class='mc-list'>
                                    ...
                                    `<tr class='mc-list-row'><td></td>
                                        <td class='mc-cell-mc'><span class='mc-mc'>${x.stats.mc.toLocaleString("en-US", {minimumFractionDigits: 3})}</span></td>
        ...
        function matchCostAverage(userStats, selectedMatches){
            var ans = {};
            for(let id in userStats){
                if(userStats[id].plays > 0){
                    ans[id] = userStats[id].usertotalscore / userStats[id].plays;
                }
            }
            return ans;
        }
